...
if (isset($_POST['btnDeletePost'])) {
    ...
    // Delete query for the post
    $deleteQuery = "DELETE FROM posts WHERE postID = '$postID'";
    executeQuery($deleteQuery);

    // Redirect to update the displayed posts
    header('Location: index.php');
    exit();
}
...
<head>
    ...
    <link rel="icon" href="https://cdn-icons-png.flaticon.com/512/6049/6049685.png">
</head>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="navLink active" aria-current="page" href="#">Home</a></li>
                    <li class="nav-item"><a class="navLink" href="#about">About</a></li>
                    <li class="nav-item"><a class="navLink" href="#post">Posts</a></li>
                    <li class="nav-item"><a class="navLink" href="#add">Add</a></li>
                    <li class="nav-item"><a class="navLink" href="#footer">Contact</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container mt-4">
        <div class="display3" id="about">Parrhesia</div>
        <p class="introText">
            A world where all can be free to express themselves without any hesitations.
            <img class="img-fluid card w-100 rounded mt-2"
                src="https://t4.ftcdn.net/jpg/09/75/00/69/360_F_975006975_LV0aiigkcjOB0jbimmzZZxaXlVqvjTsI.jpg">
        </p>
        <hr class="my-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-4" id="post">
                        <div class="card my-3">
                            <div class="card-body">
                                ...
                                <a href="edit.php?postID=<?php echo $post['postID']; ?>" class="btnEdit">Edit</a>
                                <form method="post" class="mt-2">
                                    <input type="hidden" name="postID" value="<?php echo $post['postID']; ?>">
                                    <button type="submit" name="btnDeletePost">Delete</button>
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <form method="post" class="my-4" id="add">
            ...
            <input type="number" name="postID" placeholder="Post ID" class="form-control mb-2" required step="1"
                oninput="this.value = this.value.replace(/[^0-9]/g, '');">
            <input type="number" name="userID" placeholder="User ID" class="form-control mb-2" required step="1"
                oninput="this.value = this.value.replace(/[^0-9]/g, '');">
